 ...
 */
public class SearchServiceRadar extends IntentService {
     ...
     */
    public SearchServiceRadar() {
        super(NetworkConstants.RADAR_SEARCH);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        broadcastIntent.setAction(NetworkConstants.RADAR_SEARCH);
